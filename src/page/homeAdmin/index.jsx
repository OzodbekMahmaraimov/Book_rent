      ...
      {title && (
        <AdminModal >
          ...
          <div className="bg-gray-200 px-4 py-3 text-right">
            ...
            <button onClick={updateTitle} className="py-2 px-4 bg-blue-500 text-white rounded font-medium hover:bg-blue-700 mr-2 transition duration-500"> Change title </button>
          </div>
        </AdminModal>
      )}
    </>
